...
namespace $rootnamespace$.Models.GoUrl
{
    public class OptionsModel
    {
        ...
        [StringLength(50)]
        public string public_key = "";       // value from your gourl.io member page - https://gourl.io/info/memberarea	
        public string private_key = "";       // value from your gourl.io member page.  Also you setup cryptocoin name on gourl.io member page
        public string webdev_key = "";     // optional, web developer affiliate key
        [Range(typeof(decimal), "0", "50000000")]
        public decimal amount = 0;     // amount of cryptocoins which will be used in the payment box/captcha, precision is 4 (number of digits after the decimal), example: 0.0001, 2.444, 100, 2455, etc.   
